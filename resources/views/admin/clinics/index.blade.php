                                ...
                                <tr class="border-t border-gray-100">
                                    ...
                                    <td class="py-2">
                                        <div class="flex items-center gap-3">
                                            <button type="button" @click="openEdit(@js(['id' => $clinic->id, 'name' => $clinic->name, 'tagline' => $clinic->tagline, 'address' => $clinic->address, 'phone' => $clinic->phone, 'email' => $clinic->email, 'gst' => $clinic->gst, 'plan' => $clinic->plan, 'status' => $clinic->status]))"
