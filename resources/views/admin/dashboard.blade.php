    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-6">
            @php
                $cards = [
                    ...
                    ['label' => 'Free / Paid', 'icon' => 'fa-scale-balanced', 'value' => $stats['free_count'].' / '.$stats['paid_count']],
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 p-5">
            <div class="flex items-center justify-between mb-4">
                <h3 class="font-semibold text-gray-900 dark:text-white">Recent Clinics</h3>
                <a href="{{ route('admin.clinics.index') }}" class="text-sm font-medium text-indigo-600 hover:text-indigo-800">View all</a>
            </div>
                        ...
                        <tbody>
                            @foreach ($recentClinics as $clinic)
                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    ...
                                    <td class="py-2">
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-indigo-50 text-indigo-700 uppercase">{{ $clinic->plan }}</span>
                                    </td>
