<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="rounded-2xl border border-gray-200 bg-white p-6">
                <h3 class="font-semibold text-gray-900 mb-4">Clinic Info</h3>
                <form method="POST" action="{{ route('settings.clinic') }}" class="space-y-4">
                    ...
                    <div>
                        ...
                        <x-text-input id="clinic_name" name="name" class="block mt-1 w-full" :value="old('name', $clinic->name)"
                            required />
                    ...
                    <div>
                        ...
                        <textarea id="clinic_address" name="address" rows="2"
                            class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('address', $clinic->address) }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <x-text-input id="clinic_email" type="email" name="email" class="block mt-1 w-full"
                    ...
                    <button type="submit"
                        class="w-full inline-flex items-center justify-center px-4 py-2.5 rounded-lg font-medium text-white bg-indigo-600 hover:bg-indigo-700">
                        Save
                    </button>
                </form>
            </div>
            ...
            <div class="rounded-2xl border border-gray-200 bg-white p-6" x-data="{
                ...
                <h3 class="font-semibold text-gray-900 mb-4">Clinic Logo</h3>

                <div class="flex flex-col items-center">
                    <div
                        class="w-12 h-12 rounded-full overflow-hidden bg-gray-100 flex items-center justify-center mb-4">
                    ...
                    <label
                        class="w-full border-2 border-dashed border-gray-200 rounded-lg py-6 text-center cursor-pointer hover:border-indigo-300"
                        ...
                        <p class="text-sm text-gray-500" x-text="uploading ? 'Uploading…' : 'Click or drag to upload'">
                        </p>
                        <p class="text-xs text-gray-400 mt-1">PNG or JPG, up to 2MB</p>
                    </label>

                    <button type="button" x-show="logoUrl" x-cloak @click="remove()"
            ...
            <!-- Language -->
            <div class="rounded-2xl border border-gray-200 bg-white p-6">
                <h3 class="font-semibold text-gray-900 mb-4">Language</h3>
 ...
 {{ $clinic->language === $code ? 'text-white' : 'bg-gray-50 text-gray-600 hover:bg-gray-100' }}"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="rounded-2xl border border-gray-200 bg-white p-6">
                ...
                <form method="POST" action="{{ route('settings.password') }}" class="space-y-4">
                    ...
                    <button type="submit"
                        class="inline-flex items-center justify-center px-4 py-2.5 rounded-lg font-medium text-white bg-indigo-600 hover:bg-indigo-700">
                        Update Password
                    </button>
                </form>
            </div>
            ...
            <div class="rounded-2xl border border-gray-200 bg-white p-6">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-semibold text-gray-900">Your Plan</h3>
                    <span
                        class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold uppercase bg-indigo-50 text-indigo-700">
                        {{ $clinic->plan }}
                    </span>
                </div>
