    ...
    <div class="container">
                ...
                <td style="width: 40%; vertical-align: top;">
                    <table style="width: 100%; background-color: #0b1e3d;">
                        ...
                        <tr>
                            ...
                            <td style="color: #ffffff; font-size: 8pt; padding: 3px 8px; text-align: right;">{{ $invoice->invoice_no }}</td>
                        </tr>
                        <tr>
                            <td style="color: #9ca3af; font-size: 8pt; padding: 3px 8px;">Date</td>
                            <td style="color: #ffffff; font-size: 8pt; padding: 3px 8px; text-align: right;">{{ $invoice->invoice_date->format('d M Y') }}</td>
                        </tr>
                        <tr>
                            <td style="color: #9ca3af; font-size: 8pt; padding: 3px 8px;">Status</td>
                            <td style="padding: 3px 8px; text-align: right;">
                                <span style="background-color: {{ $invoice->status === 'paid' ? '#059669' : '#dc2626' }}; color: #ffffff; font-size: 7pt; font-weight: bold; padding: 2px 6px;">
                        ...
                        <tr>
                            ...
                            <td style="color: #ffffff; font-size: 8pt; padding: 3px 8px 8px; text-align: right;">{{ $doctorName }}</td>
                        </tr>
                    </table>
                </td>
            </tr>
            ...
            <tbody>
                @foreach ($invoice->items as $i => $item)
                    <tr style="background-color: {{ $i % 2 === 0 ? '#ffffff' : '#f9fafb' }};">
                        ...
                        <td style="text-align: right; font-weight: bold;">₹{{ number_format($item['qty'] * $item['price'], 2) }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
                ...
                <td style="width: 45%;">
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td style="padding: 3px 0; font-size: 9pt; text-align: right;">₹{{ number_format($invoice->subtotal, 2) }}</td>
                        </tr>
                        <tr>
                            <td style="padding: 3px 0; font-size: 9pt; color: #6b7280;">Discount ({{ $invoice->discount_pct }}%)</td>
                            <td style="padding: 3px 0; font-size: 9pt; text-align: right; color: #dc2626;">- ₹{{ number_format($invoice->discount_amount, 2) }}</td>
                        </tr>
                        <tr>
                            <td style="padding: 3px 0; font-size: 9pt; color: #6b7280;">GST ({{ $invoice->tax_pct }}%)</td>
                            <td style="padding: 3px 0; font-size: 9pt; text-align: right;">+ ₹{{ number_format($invoice->tax_amount, 2) }}</td>
                        </tr>
                        <tr>
            ...
            <table style="width: 100%; background-color: #ecfdf5; margin-bottom: 6mm;">
                <tr>
                    <td style="padding: 8px 10px; font-size: 8pt; color: #065f46;">
                        <strong>Payment:</strong> Please complete payment at your earliest convenience. For queries, contact {{ $clinic->phone ?: '+91 8488055253' }}.
                    </td>
                </tr>
            </table>
        @endif
        ...
        <table style="width: 100%; margin-top: 14mm;">
            <tr>
                ...
                <td style="width: 45%; border-top: 1px dashed #9ca3af; padding-top: 4px; font-size: 8pt; color: #6b7280; text-align: right;">
