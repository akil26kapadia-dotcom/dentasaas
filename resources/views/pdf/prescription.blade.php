    ...
    <div class="container">
        ...
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 38%; vertical-align: top; text-align: right;">
                    <table style="width: 100%; background-color: #ecf3ff;">
                        <tr>
                            <td style="padding: 10px; text-align: center;">
                                <div style="font-size: 26pt; font-weight: bold; color: #465fff; font-family: serif;">Rx
                                </div>
                                <div style="font-size: 8pt; font-weight: bold; letter-spacing: 2px; color: #2a31d8;">
                                    PRESCRIPTION</div>
                            </td>
                        </tr>
                    </table>
        ...
        <table class="meta-row" style="width: 100%; margin-top: 6mm;">
            <tr>
                ...
                <td style="width: 33%; text-align: right;">Ref#:
                    <strong>RX-{{ str_pad($prescription->id, 5, '0', STR_PAD_LEFT) }}</strong></td>
            </tr>
        </table>
        ...
        <table style="width: 100%; background-color: #f3f4f6; margin-bottom: 8mm;">
            <tr>
                <td style="width: 55%; border-left: 3px solid #465fff; padding: 6px 10px;">
                    <div style="font-size: 7pt; color: #6b7280; letter-spacing: 1px;">PATIENT</div>
                    <div style="font-size: 13pt; font-weight: bold; color: #111827;">{{ $prescription->patient_name }}
                    </div>
                </td>
        ...
        <div style="height: 2px; background-color: #465fff; width: 40mm; margin-bottom: 5mm;"></div>
                    ...
                    <tr style="background-color: {{ $i % 2 === 0 ? '#ffffff' : '#f9fafb' }};">
                        ...
                        <td>
                            ...
                            @if (!empty($med['instructions']))
                                <div style="font-style: italic; color: #465fff; font-size: 8pt;">
                        ...
                        <td>
                            <span
                                style="background-color: #dde9ff; color: #2a31d8; font-size: 7pt; font-weight: bold; padding: 2px 6px;">
                                {{ $med['freq'] }}
                            </span>
                        </td>
                        <td>{{ $med['duration'] }}</td>
        ...
        @if ($prescription->notes)
            <table style="width: 100%; background-color: #ecf3ff; margin-bottom: 8mm;">
                <tr>
                    <td style="padding: 8px 10px; font-size: 8pt; color: #2a31d8;">
            ...
            <tr>
                ...
                <td style="width: 45%; text-align: right;">
                    <table style="margin-left: auto; border: 1px dashed #9ca3af;">
                        <tr>
                            <td style="padding: 14px 24px; font-size: 8pt; color: #9ca3af; text-align: center;">[ STAMP
                                ]</td>
                        </tr>
                    </table>
                </td>
